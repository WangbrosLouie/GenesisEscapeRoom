...
if [ -z $FILE_NAME ]
then
echo "Oh $USER, please enlighten me with the name or path of the 68k assembly file that you wish for me to compile."
read FILE_NAME
if [ -z $FILE_NAME ]
then
...
vasmm68k_mot $FILE_NAME -chklabels -nocase -Dvasm=1 -DBuildGEN=1 -Fbin -o $OUTPUT_NAME
